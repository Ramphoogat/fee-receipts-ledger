...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/fee-receipts-ledger-rfa2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/fee-receipts-ledger-rfa2/settings/integrations/github)
